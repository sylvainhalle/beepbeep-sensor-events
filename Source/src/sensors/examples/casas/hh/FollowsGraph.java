/*
    ...
    Copyright (C) 2023 Sylvain Hallé, Rania Taleb
	...
	public static void main(String[] args) throws FileSystemException, IOException
	{
		...
		ApplyFunction is_motion = new ApplyFunction(new FunctionTree(Booleans.or, 
				new FunctionTree(Booleans.or,
						...
						new FunctionTree(Booleans.or, 
								new FunctionTree (Equals.instance, format.sensorString(), new Constant("Control4-LightSensor")), 
								new FunctionTree(Equals.instance, format.sensorString(),new Constant("Control4-BatteryPercent")))),
				new FunctionTree(Equals.instance, format.sensorString(), new Constant("Control4-Radio"))));
