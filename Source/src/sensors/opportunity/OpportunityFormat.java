...
public class OpportunityFormat implements LabeledEventFormat
{
	...
	public static final String[] COL_NAMES = new String[] { "MILLISEC", "Accelerometer RKN^ accX",
			...
			"Accelerometer CUP accX", "Accelerometer CUP accX", "Accelerometer CUP accX",
			"Accelerometer CUP gyroX", "Accelerometer CUP gyroY", "Accelerometer SALAMI accX",
			"Accelerometer SALAMI accX", "Accelerometer SALAMI accX", "Accelerometer SALAMI gyroX",
			"Accelerometer SALAMI gyroY", "Accelerometer WATER accX", "Accelerometer WATER accX",
			"Accelerometer WATER accX", "Accelerometer WATER gyroX", "Accelerometer WATER gyroY",
			"Accelerometer CHEESE accX", "Accelerometer CHEESE accX", "Accelerometer CHEESE accX",
			"Accelerometer CHEESE gyroX", "Accelerometer CHEESE gyroY", "Accelerometer BREAD accX",
			"Accelerometer BREAD accX", "Accelerometer BREAD accX", "Accelerometer BREAD gyroX",
			"Accelerometer BREAD gyroY", "Accelerometer KNIFE1 accX", "Accelerometer KNIFE1 accX",
			"Accelerometer KNIFE1 accX", "Accelerometer KNIFE1 gyroX", "Accelerometer KNIFE1 gyroY",
			"Accelerometer MILK accX", "Accelerometer MILK accX", "Accelerometer MILK accX",
			"Accelerometer MILK gyroX", "Accelerometer MILK gyroY", "Accelerometer SPOON accX",
			"Accelerometer SPOON accX", "Accelerometer SPOON accX", "Accelerometer SPOON gyroX",
			"Accelerometer SPOON gyroY", "Accelerometer SUGAR accX", "Accelerometer SUGAR accX",
			"Accelerometer SUGAR accX", "Accelerometer SUGAR gyroX", "Accelerometer SUGAR gyroY",
			"Accelerometer KNIFE2 accX", "Accelerometer KNIFE2 accX", "Accelerometer KNIFE2 accX",
			"Accelerometer KNIFE2 gyroX", "Accelerometer KNIFE2 gyroY", "Accelerometer PLATE accX",
			"Accelerometer PLATE accX", "Accelerometer PLATE accX", "Accelerometer PLATE gyroX",
			"Accelerometer PLATE gyroY", "Accelerometer GLASS accX", "Accelerometer GLASS accX",
			"Accelerometer GLASS accX", "Accelerometer GLASS gyroX", "Accelerometer GLASS gyroY",
